...
if (login === null) {
    ...
    function title(arr) {
        ...
        arr.forEach(function(data) {
            if (data.order_state === 0) { $bb = "訂單未確認" } else if (data.order_state === 1) { $bb = "訂單取消" } else if (data.order_state === 2) { $bb = "訂單確認" } else if (data.order_state === 3) { $bb = "可取貨" } else if (data.order_state === 4) { $bb = "已出貨" } else if (data.order_state === 5) { $bb = "已完成" };
    ...
    function search1() {
        ...
        function title1(arr1) {
            ...
            arr1.forEach(function(data1) {
                if (data1.order_state === 0) { $bb = "訂單未確認" } else if (data1.order_state === 1) { $bb = "訂單取消" } else if (data1.order_state === 2) { $bb = "訂單確認" } else if (data1.order_state === 3) { $bb = "可取貨" } else if (data1.order_state === 4) { $bb = "已出貨" } else if (data1.order_state === 5) { $bb = "已完成" };
