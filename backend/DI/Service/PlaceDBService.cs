...
namespace DI.Service
{
    public class PlaceDBService
    {
        ...
        //總覽產地
        public List<PlaceAllViewModels> AllPlace()
        {
        ...
        //總覽產地(id搜尋)
        public List<PlaceOneViewModels> IdPlace(string place_id)
        {
            string Sql = string.Empty;
            if (string.IsNullOrWhiteSpace(place_id)==false)
            {
                Sql = "SELECT * FROM place where place_id LIKE '%' + @place_id + '%'";
            }
            else
            {
