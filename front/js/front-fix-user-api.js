    ...
    function order(arr) {
        ...
        <div class="sex-bir">
            <div class="radio-user">性別：
                <div class="aaa">
                    <input type="radio" name="sex" style="ZOOM:1.5" id="sex1" class="readonly" value='false' ${
                      data.user_gender === false ? "checked" : ""
                    }><label for="sex">男　</label>
                    <input type="radio" name="sex" style="ZOOM:1.5" id="sex1" class="readonly" value='true' ${
                      data.user_gender === true ? "checked" : ""
